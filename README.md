...
`class="todo"` — 6 markers, all in `about.html` (3) and `booking.html` (3).
`case-studies.html` is fully complete — all 3 case studies real. Grey dashed boxes are photo/video placeholders.
